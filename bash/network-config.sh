...
myLanAddress=$(ip a s $Interface | awk '/inet /{gsub(/\/.*/,"");print $2}')
myLanHostname=$(getent hosts $myLanAddress | awk '{print $2}')
...
myRouterAddress=$(ip r | awk '/via /{gsub(/\/.*/,"");print $3}')
myRouterHostname=$(getent hosts $myRouterAddress | awk '{print $2}')
