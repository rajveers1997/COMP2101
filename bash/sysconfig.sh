...
function cleanup {
  rm /tmp/*.$$
  echo "All the temp files created by script are deleted"
  exit
}
trap cleanup
...
=======
  ~/netid.sh
>>>>>>> fb053a809a80fd46e476da443774286bca85c46d
}
